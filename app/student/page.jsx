            ...
            <div className="flex flex-col md:flex-row w-full h-screen">
                ...
                <div className="w-full md:w-1/3 bg-[#08183A] flex flex-col items-center justify-between p-4">
                    ...
                    <div className="flex flex-col items-center justify-center flex-1">
                        ...
                        <p className="text-white mt-6 text-center text-xl">Student login</p>
                    </div>
                </div>
                {/* Right Container */}
                <div className="flex-1 flex flex-col justify-center items-center p-8 bg-white">
                    ...
                    <input 
                        ...
                        className="mb-4 p-2 placeholder-[#08183A] border border-[#08183A] text-[#08183A] rounded w-full max-w-xs" 
                    />
