                    ...
                    <div className="flex flex-col lg:flex-row lg:space-x-4 relative">
                        ...
                        <div className="w-full lg:w-3/4 p-6 rounded-lg">
                            <form className="space-y-4">
                                ...
                                <div className="flex items-center space-x-2">
                                    <label htmlFor="studentPassword" className="text-2xl font-medium text-gray-700 w-1/3">Create Password:</label>
                                    <input type="password" id="studentPassword" className="p-2 border border-gray-300 rounded-md flex-grow" placeholder="Create a password" />
                                </div>
